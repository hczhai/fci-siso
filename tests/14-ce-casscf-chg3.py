...
cas_list = [27, 28, 29, 30, 31, 32, 33, 34]
mc = mcscf.CASSCF(mf, 8, 1)
...
# Expt. 2253 cm-1 (NIST Energy Levels and Wavelengths Bibliographic Reference # 3974)
