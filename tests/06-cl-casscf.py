...
print("ZFS 2P  1/2 - 3/2 exp. = %10.4f cm-1" % 882.35)

# https://physics.nist.gov/PhysRefData/Handbook/Tables/chlorinetable5.htm
# expr        882.35 cm-1
# ccpv5z-dk   839.0456 cm-1
# ccpvqz-dk   838.4341 cm-1
# ccpvtz-dk   835.0110 cm-1
# ccpvdz-dk   832.4235 cm-1