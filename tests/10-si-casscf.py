...
au2cm = 219474.63
print("E 3P  (J = 1) - (J = 0) = %10.4f cm-1    exp. = %10.4f cm-1" % ((e1 - e0) * au2cm, 77.112))
print("E 3P  (J = 2) - (J = 0) = %10.4f cm-1    exp. = %10.4f cm-1" % ((e2 - e0) * au2cm, 223.157))
print("E 1D(J = 2) - 3P(J = 0) = %10.4f cm-1    exp. = %10.4f cm-1" % ((e3 - e0) * au2cm, 6298.847))

# https://physics.nist.gov/PhysRefData/Handbook/Tables/silicontable5.htm
# expr        77.112     223.157    6298.847   cm-1
# ccpv5z-dk   64.3146    191.9882   8851.4802  cm-1
# ccpvqz-dk   64.1889    191.6152   8854.1302  cm-1
# ccpvtz-dk   64.3770    192.1794   8903.2186  cm-1
# ccpvdz-dk   63.5614    189.7621   8953.8291  cm-1
