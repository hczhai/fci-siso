...
cas_list = [9, 10, 11, 12, 13, 14]
mc = mcscf.CASSCF(mf, 6, 1)
mc.fix_spin_(ss=0.75)
mo = mcscf.sort_mo(mc, mf.mo_coeff, cas_list, base=0)
mc.state_average_((0.2,) * 5)
mc.kernel(mo)
...
# Expt. 940 cm-1 (NIST Energy Levels and Wavelengths Bibliographic Reference # 7185)
